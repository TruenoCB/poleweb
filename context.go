...
/* func (c *Context) DealJson(data interface{}) error {
	body := c.R.Body
	if c.R == nil || body == nil {
...
func checkParamSlice(elem reflect.Type, data interface{}, decoder *json.Decoder) error {
...
func checkParam(value reflect.Value, data interface{}, decoder *json.Decoder) error {
